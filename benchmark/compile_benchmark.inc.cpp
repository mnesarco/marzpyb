...
void test_format_strings()
{
    ...
    constexpr auto fmt1 = fmt_concat(FmtString {"hello"}, FmtString {" world"});
    constexpr auto fmt2 = fmt_concat(FmtString {"a"}, FmtString {"b"}, FmtString {"c"});
    constexpr auto fmt3
        = fmt_concat(FmtString {"x"}, FmtString {"y"}, FmtString {"z"}, FmtString {"w"});
